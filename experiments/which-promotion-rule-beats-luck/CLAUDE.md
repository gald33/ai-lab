# Which promotion rule beats luck? · grounding
...
and commit it **before** the run. `tools/ground.py promotion` prints this bundle.
...
`tools/ground.py promotion --preflight` prints them. A failed gate is a finding and
