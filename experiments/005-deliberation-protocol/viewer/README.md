...
island was given" above. Neither was what holds the job back; that is the `ring`
flakiness measured in the section before this one. `verdict` enforces two rules: anything **not** listed fails the run, and
