# Which part of a convention works? · grounding
...
and commit it **before** the run. `tools/ground.py which-part` prints this bundle.
...
`tools/ground.py which-part --preflight` prints them. A failed gate is a finding and
