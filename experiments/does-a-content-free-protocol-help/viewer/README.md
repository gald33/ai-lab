...
import { layout } from './experiments/does-a-content-free-protocol-help/viewer/web/scene.js';
...
(`node --test experiments/does-a-content-free-protocol-help/viewer/tests/*.test.mjs`).
...
`experiments/does-a-content-free-protocol-help/tests`. It did **not** run
