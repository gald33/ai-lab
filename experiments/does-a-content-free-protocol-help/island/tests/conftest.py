...
`experiments/which-part-of-a-convention-works/experiment/conftest.py` uses -- and a real
...
and verification rather than an assumption about how they behave.
    ...
    python -m pytest experiments/does-a-content-free-protocol-help/island/tests/ -q
