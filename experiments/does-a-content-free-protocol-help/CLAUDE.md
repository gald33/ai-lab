# Does a content-free protocol help? · grounding
...
and commit it **before** the run. `tools/ground.py content-free` prints this bundle.
...
`tools/ground.py content-free --preflight` prints them. A failed gate is a finding and
