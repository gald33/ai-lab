# Is the ruin the convention or the commitment? · grounding
...
and commit it **before** the run. `tools/ground.py ruin` prints this bundle.
...
`tools/ground.py ruin --preflight` prints them. A failed gate is a finding and
